...
def main():
    ...
    access_point = "INPUT SGTIN OF YOUR ACCESS POINT. HAS TO BE 24 DIGITS. PROBABLY 3014F711A00003DA49957C22"
    devicename = "INPUT DEVICENAME HERE"
    path = "DIRECTORY PATH WHERE FILE CONTAINING AUTH TOKEN ETC. GETS SAVET TO"
